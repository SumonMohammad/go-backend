...
MODULE_NAME="github.com/SumonMohammad/$SERVICE_NAME"
REPO_NAME="ggithub.com/SumonMohammad"
...
import (
  ...
  "github.com/SumonMohammad/go-backend/pkg/rabbitmq"
  "github.com/SumonMohammad/${SERVICE_NAME}/internal/${SERVICE_NAME}/config"
  "github.com/SumonMohammad/${SERVICE_NAME}/internal/${SERVICE_NAME}/models/pg"
  "github.com/SumonMohammad/${SERVICE_NAME}/internal/${SERVICE_NAME}/service"
  "os"
)
...
import (
	...
	"github.com/spf13/cobra"
	"github.com/SumonMohammad/go-backend/pkg/log"
	"github.com/SumonMohammad/go-backend/pkg/migration"
	"github.com/SumonMohammad/go-backend/pkg/sigint"
	"github.com/SumonMohammad/go-backend/pkg/server"
	"github.com/SumonMohammad/${SERVICE_NAME}/internal/${SERVICE_NAME}/service"
	${INITIALS} "github.com/SumonMohammad/${SERVICE_NAME}/internal/${SERVICE_NAME}/server"
	"github.com/SumonMohammad/${SERVICE_NAME}/pkg/grpc"
	"github.com/SumonMohammad/${SERVICE_NAME}/sql"
	"go.uber.org/zap"
	"net/http"
)
...
import (
	...
	"github.com/SumonMohammad/go-backend/pkg/bundb"
	"github.com/SumonMohammad/go-backend/pkg/migration"
	"github.com/SumonMohammad/go-backend/pkg/pubsub"
	"github.com/SumonMohammad/go-backend/pkg/rabbitmq"
	"github.com/SumonMohammad/go-backend/pkg/server"
	"os"
)
...
import (
  ...
  "github.com/SumonMohammad/${SERVICE_NAME}/internal/${SERVICE_NAME}/service"
  pb "github.com/SumonMohammad/${SERVICE_NAME}/pkg/grpc"
  "context"
)
...
import (
    ...
    "github.com/SumonMohammad/go-backend/pkg/rabbitmq"
    "github.com/SumonMohammad/${SERVICE_NAME}/internal/${SERVICE_NAME}/config"
    "github.com/SumonMohammad/${SERVICE_NAME}/internal/${SERVICE_NAME}/models"
)
...
import (
  ...
  "github.com/SumonMohammad/go-backend/pkg/bundb"
  "github.com/SumonMohammad/go-backend/pkg/log"
  model "github.com/SumonMohammad/${SERVICE_NAME}/internal/${SERVICE_NAME}/models"
)
...
option go_package = "github.com/SumonMohammad/$SERVICE_NAME/pkg/grpc;grpc";
...
Build:
  ...
  script:
    ...
    - git config --global url.git@gitlab.techetronventures.com:core.insteadOf https://github.com/SumonMohammad
